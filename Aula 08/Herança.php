...
class Casa extends Imovel{ //De modo resumido, o extends puxa as informações da outra class
    private $tem_quintal; //Atributo booleano - true ou falso
        //O costruct da segunda class tem q ter os da primeira class
